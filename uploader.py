...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def list_directory(self, path):
        ...
        f.write(b"<hr>\n")
        f.write(
            b'<a href="../"><img src="data:image/gif;base64," alt="[PARENTDIR]" width="24" height="24">&nbsp;&nbsp;&nbsp;Parent Directory</a><br />\n')
        for name in list:
